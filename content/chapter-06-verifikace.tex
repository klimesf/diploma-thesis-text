...
tř\'{\i}dy \code{BusinessContextWeaver} ověřuj\'{\i}c\'{\i},
že byly správně aplikovány post-conditions daného byznys kontextu, konkrétně
zakrytí pole \code{email} objektu \code{user}. Anotace \code{@Test} metody \code{test()} znač\'{\i},
...
nástroje \code{unittest}\footnote{https://docs.python.org/3/library/unittest.html}, inspirovaného nástrojem
...
rozšiřuje oficiáln\'{\i} image \code{library/node:9.11.1}\footnote{https://hub.docker.com/\_/node/}
