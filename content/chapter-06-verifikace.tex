...
\begin{table}[h]
    ...
    \begin{tabular*}{\textwidth}{ l l }
        ...
        \textbf{UC12} & Administrátor může vystavit fakturu \\
        \hline
    \end{tabular*}
...
\begin{table}
    ...
    \begin{tabular}{ l l c r }
        ...
        \textbf{BR05} & UC04, UC13 & \makecell[c]{Uživatel mus\'{\i} řádně vyplnit fakturačn\'{\i} \\ adresu (č.p., ulice, město, PSČ, stát)} & pre \\ \hline
        ...
        \textbf{BR15} & UC07 & Skladn\'{\i}k nesm\'{\i} vidět celkov\'y součet cen objednávek & post \\ \hline
        \textbf{BR16} & UC08 & \makecell[c]{Stav objednávky mus\'{\i} b\'yt pouze "přijato", \\ "expedováno" a "doručeno"} & pre \\ \hline
        \textbf{BR17} & UC09 až UC12 & \makecell[c]{Administrátor mus\'{\i} b\'yt do systému přihlášen \\ a m\'{\i}t roli "Administrátor"} & pre \\ \hline
        \textbf{BR18} & UC10 & \makecell[c]{V\'ysledná cena produktu mus\'{\i} b\'yt větš\'{\i} \\ než jeho nákupn\'{\i} cena} & pre \\ \hline
        \textbf{BR19} & UC11 & Skladn\'{\i}k mus\'{\i} m\'{\i}t jméno delš\'{\i} než 2 znaky & pre \\ \hline
        \textbf{BR20} & UC11 & Skladn\'{\i}k mus\'{\i} m\'{\i}t emailovou adresu v platném formátu & pre \\
        \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular*}{\textwidth}{ l c l }
        ...
        \textbf{billing.createInvoice} & - & BR05 \\ \hline
...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{ l X | l X }
        ...
        \textbf{BR08} & order & \textbf{BR18} & product \\
