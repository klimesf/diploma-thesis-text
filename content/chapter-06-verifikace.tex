...
a tím byla verifikována jejich správná funkcionalita. Způsob
testování knihoven si popíšeme zvlášť pro každou platformu.
...
a framework se postará o jeho automatickou distribuci do všech m\'{\i}st, kde
...
\textit{75 \%} použit\'ych pravidel přejat\'ych z byznysov\'ych kontextů patř\'{\i}c\'{\i}ch jin\'ym službám.
...
identifikovat byznysové kontexty, jejich hirearchii a vazbu byznysov\'ych pravidel,
aby bylo možno framework efektivně využ\'{\i}vat. To může vyžadovat v\'{\i}ce času, než klasick\'y návrh.
Ovšem investice by se měla vrátit v průběhu v\'yvoje a údržby systému sn\'{\i}žen\'ymi časov\'ymi
nároky při změnov\'ych ř\'{\i}zen\'{\i}ch. Framework nav\'{\i} snižuje riziko lidské
chyby.
