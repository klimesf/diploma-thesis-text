...
\begin{table}[h]
    ...
    \begin{tabular*}{\textwidth}{ l l }
        ...
        \textbf{UC02} & Zákazn\'{\i}k může prohl\'{\i}žet seznam produktů \\
        \textbf{UC03} & Zákazn\'{\i}k může vkládat produkty do koš\'{\i}ku \\
        \textbf{UC04} & Zákazn\'{\i}k může vytvořit objednávku \\
        \textbf{UC05} & Skladn\'{\i}k může prohl\'{\i}žet detail produktu \\
...
\begin{table}
    ...
    \begin{tabular}{ l l c r }
        ...
        \textbf{BR12} & UC02, UC05 & \makecell[c]{Skladn\'{\i}k u produktu nesm\'{\i} vidět nákupn\'{\i} cenu, \\ pouze v\'yslednou cenu} & post \\ \hline
