...
Jednotkové testy jsou nejnížší úrovní testování, která má za úkol ověřit správnou
...
Průběžné integrace (z anglického \textit{continous integration} -- \gls{CI})~\cite{fowler2006continuous}
slouží k urychlení nalezení defektů software ve fázi vývoje. Nové verze zdrojového kódu jsou do projektu pravidelně
integrovány v krátkých časových intevalech a jejich funkčnost je ověřována automatickými testy. K tomu je
...
testů~\cite{luo2001software} a t\'{\i}m byla ověřena jejich správná funkcionalita. Způsob
