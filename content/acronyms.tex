...
\newglossaryentry{IBM}{name=IBM,description={International Business Machine}}
...
\newglossaryentry{MDD}{name=MDD,description={Model-Driver Architecture}}
...
\newglossaryentry{OCL}{name=OCL,description={Object Constraint Language}}
