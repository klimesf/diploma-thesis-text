...
% TODO: ilustace tangled vs. untangled kódu
...
je Aspect-driven Design Approach (\gls{ADDA})~\cite{cemus2014aspect} ().
...
\paragraph{Automatická integrace byznysových pravidel v uživatelských rozhraních}
...
\subsection{Použití pro tuto práci}
