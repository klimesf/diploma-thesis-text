...
logování, transakcí a byzynsových pravidel zachyceny mimo metodu \code{createOrder},
...
Přístup \gls{ADDA} má implikace na architekturu systému, který ho využívá.
...
je znázorněna na obrázku~\ref{fig:adda-architecture}~\cite{cemus2017separation}. Kromě
standardních tří vrstev jsou součástí systému i registry aspektů. Pomocí \gls{REST}
\gls{API} jsou aspekty ze \textit{single-focal point} distribuovány do uživatelských
rozhraní na různých platformách.

\subsection{Výhody a nevýhody}

Využití přístupu \gls{ADDA} umožňuje splnění požadavků této práce,
