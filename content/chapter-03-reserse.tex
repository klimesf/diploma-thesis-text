...
v\'yše zmiňovaných problémů. Využívá k tomu \textit{separation of concerns} --
...
pro jazyk Python\footnote{\url{https://pypi.org/project/business-rules/}}, projekt
FlexRule\footnote{\url{http://www.flexrule.com/archives/business-rule-language/}} pro platformy .NET a
...
je \textit{JetBrains MPS} (Meta Programming System)\footnote{\url{https://www.jetbrains.com/mps/}}.
