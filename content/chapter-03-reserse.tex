...
uvedeno, které dialekty jsou v pravidle využity. Dialekt \code{mvel} je popsán v předchozím textu.
...
%\textendash\xspace například přidat do jazyka Java podporu pro jednoduchý vizuální
