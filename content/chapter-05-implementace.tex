...
Ačkoliv není specifikace a vytvoření doménově specifického jazyka (DSL) % TODO: zkratka
...
bude umět jazyk zpracovat a sestavit z něj AST. % TODO: co je ast? popsat?
...
navrženému metamodelu byznysového kontextu z kapitoly~\red{ch:navrh}.
