...
\paragraph{CommitTransaction()} dokončí probíhající transakci a uloží všechny změny byznysových kontextů.
...
Návrh frameworku vyžaduje, aby logické výrazy byzynsových pravidel byly reprezentovány
...
vyhodnocení výrazů, jak bylo popsáno v předchozím textu. Zároveň je tím usnadněno
