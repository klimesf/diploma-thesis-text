...
nejpopulárnějš\'{\i}ch jazyků pro obecné použit\'{\i}.
...
\goal{Detekce duplicitních kontextů}
...
strukturou je například \code{HashSet}~\cite{hopcroft1983data}.

\goal{Detekce cyklů v grafu závislost\'{\i}}
Pro tuto detekci cyklů v grafu závislosti pravidel popsanou v sekci~\ref{sec:context-inheritance} byl
zvolen Tarjanův algoritmus~\cite{tarjan1971depth}. Ten umožňuje detekci souvisl\'ych
komponent a disponuje velmi dobrou lineárn\'{\i} složitost\'{\i}, závislou na součtu počtu hran a
počtu uzlů grafu.
