...
je popsána pouze pro platformu Java a ostatní jsou shrnuty
...
pomocí \textit{XML Schema Definition} (\gls{XSD}).
...
Implementuje specifikaci \textit{Document Object Model} (\gls{DOM})
...
v jazyce JavaScript, konkrétně jeho verzi \textit{ECMAScript 6.0}.
